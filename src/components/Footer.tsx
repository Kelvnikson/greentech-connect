...
const footerLinks = {
  platform: [
    { label: "Para Indústrias", href: "#" },
    { label: "Para Governo", href: "#" },
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm">
              Conectando práticas de sustentabilidade corporativa a soluções 
              tecnológicas verdes para um futuro mais sustentável.
            </p>
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="w-10 h-10 rounded-lg bg-background border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/30 transition-all duration-200"
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © 2024 GreenLinkHub. Todos os direitos reservados.
          </p>
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <span className="w-2 h-2 rounded-full bg-primary animate-pulse" />
            Contribuindo com o ODS 9
          </div>
        </div>
      </div>
    </footer>
