...
const steps = [
  {
    ...
    description: "Indústrias registram seus desafios de sustentabilidade e metas ESG. Startups publicam suas soluções verdes inovadoras.",
  },
  {
    number: "02",
    icon: Handshake,
    title: "Matchmaking Inteligente",
    description: "Nossa IA conecta automaticamente as melhores soluções às demandas industriais, considerando setor, escala e maturidade tecnológica.",
  },
  {
    number: "03",
    icon: BarChart3,
        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            {steps.map((step, index) => (
              ...
              >
                {/* Step Card */}
                <div className="bg-card rounded-2xl p-6 border border-border shadow-soft hover:shadow-medium hover:border-primary/20 transition-all duration-300 group">
                  {/* Number Badge */}
