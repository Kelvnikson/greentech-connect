...
import { Leaf, Factory, Building2, Lightbulb, ArrowLeft, CheckCircle2 } from "lucide-react";

type UserType = "industria" | "governo" | "startup" | null;
...
const userTypes = [
  {
    ...
    icon: Factory,
    title: "Indústria",
    description: "Busco soluções tecnológicas sustentáveis para minha operação",
  },
  {
    id: "governo" as const,
    icon: Building2,
  ...
  },
  {
    ...
    description: "Tenho soluções verdes e quero conectar com indústrias",
  },
];
            ...
            <div className="animate-fade-up">
              <div className="text-center mb-12">
                <h1 className="font-display font-bold text-3xl md:text-4xl text-foreground mb-4">
                  Como você quer usar o GreenLinkHub?
                </h1>
